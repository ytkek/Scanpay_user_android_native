...
import ths.ScanPay_User.LocationActivity;
import ths.ScanPay_User.LocationAdapter;
import ths.ScanPay_User.Locationlist;
import ths.ScanPay_User.NetworkUtil;

/**
 * Created by Windows on 20/9/2016.
 */
public class GetScanPayMerchantListTask extends AsyncTask<Void, Integer, ArrayList<Locationlist>> {
    ...
    @Override
    protected ArrayList<Locationlist> doInBackground(Void... params)
    {
