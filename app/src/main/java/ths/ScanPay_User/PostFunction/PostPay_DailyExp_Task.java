 ...
 */
public class PostPay_DailyExp_Task extends AsyncTask<String, Integer, String> {
    ...
    public PostPay_DailyExp_Task(Activity context){
    ...
    protected String doInBackground(String... params)
    {
        ...
        String response="";
        String apiUrl = ApiUrl.Domain + ApiUrl.PostPay_DailyExp_Api ;
