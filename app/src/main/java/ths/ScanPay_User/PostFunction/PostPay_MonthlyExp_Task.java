 ...
 */
public class PostPay_MonthlyExp_Task extends AsyncTask<String, Integer, String> {
    ...
    public PostPay_MonthlyExp_Task(Activity context){
    ...
    protected String doInBackground(String... params)
    {
        ...
        String response="";
        String apiUrl = ApiUrl.Domain + ApiUrl.PostPay_MonthlyExp_Api ;
    ...
    protected void onPostExecute(String result)
    {
       ...
       // Toast.makeText(context,result,Toast.LENGTH_SHORT).show();
        PaymentScanQRActivity.monthlyexp = result;
