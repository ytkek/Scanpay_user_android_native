...
import ths.ScanPay_User.PostFunction.PostPay_Confirm_Pay_Task;
import ths.ScanPay_User.PostFunction.PostTopup_Confirm_Topup_Task;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new PostTopup_Confirm_Topup_Task(c).execute(MainActivity.LoginID,TopUpScanQRActivity.merchantid,TopUpScanQRActivity.merchantname,TopUpScanQRActivity.type,TopUpScanQRActivity.amount_edit.getText().toString(),TopUpScanQRActivity.qrcode,TopUpScanQRActivity.lqrcode);
            }
        });
