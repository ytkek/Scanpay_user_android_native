...
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_Dob_Task;
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_Gender_Task;
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_MobileNumber_Task;
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_Name_Task;
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_NewPassword_Task;
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_NickName_Task;
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_Pin_Payment_Task;
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_Recover_Pin_Task;
import ths.ScanPay_UserV5.PostFunction.PostUserProfile_Remarks_Task;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(data.equals("fullname"))
        {
            ...
            savebtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   dismiss();
                   new PostUserProfile_Name_Task(c).execute(fullnameedit.getText().toString(),MainActivity.LoginID,MainActivity.LoginID,MainActivity.Password);
                }
            });
        }
        ...
        if(data.equals("mobile"))
        {
            ...
            savebtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dismiss();
                    new PostUserProfile_MobileNumber_Task(c).execute(MainActivity.LoginID,mobilenumberedit.getText().toString(),MainActivity.LoginID,MainActivity.Password);
                }
            });
        }
            ...
            savebtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!genderedit.getText().toString().equals("")&& gender_error_message.getVisibility()==View.INVISIBLE)
                    {
                        gender_error_message.setVisibility(View.INVISIBLE);
                        dismiss();
                        new PostUserProfile_Gender_Task(c).execute(MainActivity.LoginID,genderedit.getText().toString(),MainActivity.LoginID,MainActivity.Password);
                    }
                    else
                    {
                        gender_error_message.setVisibility(View.VISIBLE);
            ...
            savebtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(!nicknameedit.getText().toString().equals("")&& nickname_error_message.getVisibility()==View.INVISIBLE)
                    {
                        nickname_error_message.setVisibility(View.INVISIBLE);
                        dismiss();
                        new PostUserProfile_NickName_Task(c).execute(nicknameedit.getText().toString(),MainActivity.LoginID,MainActivity.LoginID,MainActivity.Password);
                    }
                    else
                    {
            ...
            savebtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(!remarkedit.getText().toString().equals("")&& remark_error_message.getVisibility()==View.INVISIBLE)
                    {
                        remark_error_message.setVisibility(View.INVISIBLE);
                        dismiss();
                        new PostUserProfile_Remarks_Task(c).execute(remarkedit.getText().toString(),MainActivity.LoginID,MainActivity.LoginID,MainActivity.Password);
                    }
                    else
                    {
            ...
            savebtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(!dobedit.getText().toString().equals("")&&dob_error_message.getVisibility()==View.INVISIBLE)
                    {
                        dob_error_message.setVisibility(View.INVISIBLE);
                        dismiss();
                        new PostUserProfile_Dob_Task(c).execute(dobedit.getText().toString(),MainActivity.LoginID,MainActivity.LoginID,MainActivity.Password);
                    }
                    else
                    {
        ...
        if(data.equals("pin"))
        {
            ...
            forgotpin_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    new PostUserProfile_Recover_Pin_Task(c).execute(GlobalVariable.OldPin,GlobalVariable.OldEmail,GlobalVariable.OldName,MainActivity.LoginID,MainActivity.Password);
                }
            });
