...
import ths.ScanPay_UserV5.LocationActivity;
import ths.ScanPay_UserV5.LocationAdapter;
import ths.ScanPay_UserV5.Locationlist;
import ths.ScanPay_UserV5.NetworkUtil;

/**
 * Created by Windows on 20/9/2016.
 */
public class GetScanPayMerchantListTask extends AsyncTask<String, Integer, ArrayList<Locationlist>> {
    ...
    public GetScanPayMerchantListTask(Activity context, RecyclerView list)
    {
    ...
    @Override
    protected ArrayList<Locationlist> doInBackground(String... params)
    {
        ...
        listMockData = new ArrayList<Locationlist>();
        if (NetworkUtil.isNetworkAvailable(context))
        {
            ...
            try
            {
                ...
                for (int i = 0; i < jArray.length(); i++)
                {
                    ...
                    Locationlist newsData = new Locationlist();
    ...
    @Override
    protected void onPostExecute(final ArrayList<Locationlist> result)
    {
        ...
        String code;
        ArrayList<Locationlist> sortresult = new ArrayList<Locationlist>();
            ...
            for (int i=0; i<result.size();i++)
            {
                ...
                if(i==result.size()-1)
                {
                    ...
                    LocationActivity.mAdapter = new LocationAdapter(context, sortresult);

                    LocationActivity.recyclerView.setAdapter(LocationActivity.mAdapter);
