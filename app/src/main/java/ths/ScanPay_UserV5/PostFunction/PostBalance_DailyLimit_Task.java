 ...
 */
public class PostBalance_DailyLimit_Task extends AsyncTask<String, Integer, String> {
    ...
    public PostBalance_DailyLimit_Task(Activity context){
    ...
    protected String doInBackground(String... params)
    {
        ...
        String response="";
        String apiUrl = ApiUrl.Domain + ApiUrl.PostBalance_DailyLimit_Api ;
    ...
    protected void onPostExecute(String result)
    {
       ...
       BalanceActivity.daily_limit_textview.setText("RM "+result);
       new PostBalance_DailyExp_Task(context).execute(MainActivity.LoginID,MainActivity.LoginID,MainActivity.Password);
