...
import ths.ScanPay_UserV5.RecoveryPasswordActivity;

/**
 * Created by Windows on 20/9/2016.
 */
public class PostLogin_Recover_LoginID_Password_Task extends AsyncTask<String, Integer, String> {
    ...
    public PostLogin_Recover_LoginID_Password_Task(Activity context){
    ...
    protected String doInBackground(String... params)
    {
        ...
        String response="";
        String apiUrl = ApiUrl.Domain + ApiUrl.PostLogin_Recover_LoginID_Password_Api;
