 ...
 */
public class PostUserProfile_Pin_Payment_Task extends AsyncTask<String, Integer, String> {
    ...
    public PostUserProfile_Pin_Payment_Task(Activity context){
    ...
    protected String doInBackground(String... params)
    {
        ...
        try {
            encryptedString = Encrypt(param3 + "+" + param4, "@McQfTjWnZq4t7w!");
        ...
        String response="";
        String apiUrl = ApiUrl.Domain + ApiUrl.PostUserProfile_Pin_Api;
    ...
    protected void onPostExecute(String result)
    {
        ...
        if(result.equals("SAVE PROFILE PIN PAYMENT SUCCESS"))
        {
            new GetUserProfileListTask(context).execute(MainActivity.LoginID,MainActivity.Password);
            AlertDialog.Builder builder = new AlertDialog.Builder(context);
            builder.setMessage("Alert Save Profile Pin Payment Success")
                    .setCancelable(false)
