...
public class PostVerification_Save_OTP extends AsyncTask<String, Integer, String> {
    ...
    public PostVerification_Save_OTP(Activity context){
    ...
    protected String doInBackground(String... params)
    {
        ...
        String response="";
        String apiUrl = ApiUrl.Domain + ApiUrl.PostVerification_Save_OTP_Api ;
        ...
        builder.setMessage("Alert Reset Login Complete")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Verification_LoginPage.verificationpage.finish();
                    }
                });
